...
class ConfCountries:
    ...
    supported_countries = {
        ...
        "CZ": {
            "name": "Czechia",
            "pid_url_oidc": urljoin(cfgserv.service_url, "/eidasnode/lightrequest?country=CZ"),
        ...
        "NL": {
            "name": "Netherland",
            "pid_url_oidc": urljoin(cfgserv.service_url, "/eidasnode/lightrequest?country=NL"),
        ...
        "LU": {
            "name": "Luxembourg",
            "pid_url_oidc": urljoin(cfgserv.service_url, "/eidasnode/lightrequest?country=LU"),
