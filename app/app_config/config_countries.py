...
class ConfCountries:
    ...
    supported_countries = {
        ...
        "LT": {
            "name": "Test Case LT",
            "pid_url": cfgserv.service_url + "pid/form",
            "pid_mdoc_privkey": "/root/eudi-srv-web-issuing-eudiw-py/pid-issuer/privkey/MDL-DS-0001_LT_DEV.key.pem",
            "pid_mdoc_privkey_passwd": None,  # None or bytes
        ...
        "LT-PID": {
            "name": "Test Case LT",
            "pid_url": cfgserv.service_url + "pid/form",
            "pid_mdoc_privkey": "/root/eudi-srv-web-issuing-eudiw-py/pid-issuer/privkey/PID-DS-0001_LT_DEV.key.pem",
            "pid_mdoc_privkey_passwd": None,  # None or bytes
            "pid_mdoc_cert": "/root/eudi-srv-web-issuing-eudiw-py/pid-issuer/cert/PID-DS-0001_LT_DEV.cert.der",
            "un_distinguishing_sign": "LT",
            "supported_credentials": [
                "eu.europa.ec.eudi.pid_mdoc",
                "eu.europa.ec.eudi.pid_jwt_vc_json"
