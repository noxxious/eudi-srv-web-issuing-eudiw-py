...
class ConfService:
    ...
    revocation_service_url = os.getenv("WALLET_TEST_URL", "https://issuer.eudiw.dev/token_status_list/take")
    ...
    # PID Organization ID
    pid_organization_id = os.getenv("PID_ORGANIZATION_ID", "EUDI Wallet Reference Implementation")
    ...
    mdl_issuing_authority = os.getenv("MDL_ISSUING_AUTHORITY", "EUDI Wallet Reference Implementation")
    ...
    qeaa_issuing_authority = os.getenv("QEAA_ISSUING_AUTHORITY", "EUDI Wallet Reference Implementation")
